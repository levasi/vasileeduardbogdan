import{T as f,S as v,C as h,P as x,W as _,B as S,i as P,h as T,a as b}from"./BCBTOiXd.js";import{G as y}from"./edb8ZkxD.js";import{_ as C,j as s,S as c,k as u,X as k,r as a,s as z,B,w as W,Y as L,o as M,a as n}from"./DofYlvBU.js";const G={__name:"scroll-test",setup(j){s.registerPlugin(c),u(()=>{const{$lenis:t}=k();t&&t.on("scroll",c.update)});let o=null;const l=a(null),m=a(null),p=a(null);return u(()=>{new f,new y;const t=new v;t.background=new h(9486046);const e=new x(75,window.innerWidth/window.innerHeight,.1,1e3);o=new _({antialias:!0}),o.setSize(window.innerWidth,window.innerHeight),l.value.appendChild(o.domElement);const r=new S,w=new P({uniforms:{time:{value:1},resolution:{value:new T}},vertexShader:`
