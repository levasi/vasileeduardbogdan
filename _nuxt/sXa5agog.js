import{T as f,S as v,C as h,P as x,W as _,B as S,i as T,h as P,a as b}from"./C__p7v9B.js";import{G as y}from"./B9HQ43rv.js";import{_ as C,q as s,S as c,m as u,T as k,l as a,n as z,y as W,w as B,U as L,o as M,a as n}from"./C6EthGTE.js";const G={__name:"scroll-test",setup(A){s.registerPlugin(c),u(()=>{const{$lenis:t}=k();t&&t.on("scroll",c.update)});let o=null;const l=a(null),m=a(null),p=a(null);return u(()=>{new f,new y;const t=new v;t.background=new h(9486046);const e=new x(75,window.innerWidth/window.innerHeight,.1,1e3);o=new _({antialias:!0}),o.setSize(window.innerWidth,window.innerHeight),l.value.appendChild(o.domElement);const r=new S,w=new T({uniforms:{time:{value:1},resolution:{value:new P}},vertexShader:`
